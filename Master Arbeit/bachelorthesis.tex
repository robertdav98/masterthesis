...
\lfoot{\phv \raisebox{-.24\height}{\includegraphics[height=2.5ex]{media/logo_hsrm_single_bw}}\, Robert \textsc{Davidoff}} % \, ist ein kleiner Abstand
\cfoot{\thepage}
...
\include{chapter/distributedLedgerTechnology}
...
\include{chapter/vergleich}

%----------------- KAPITEL : System-Design  ----------------- %
%\include{chapter/systemdesign}
...
%----------------- KAPITEL : Codebeispiele  --------------------- %	
\include{chapter/codebeispiele}

%----------------- KAPITEL : Evaluierungsergebnisse  --------------------- %	
\include{chapter/evaluierungsergebnisse}
